package sg.delivr.ui.interfaces;
...
public interface SHAInterface {
    ...
    public static String getDateFormattedNew(String mydate) throws ParseException {
        final Calendar c = Calendar.getInstance();
        c.add(Calendar.MONTH, 1);
    ...
    public static String getTimeFormattedNew(String mydate) throws ParseException {
        mydate = mydate.replaceAll("\\s+"," ");
